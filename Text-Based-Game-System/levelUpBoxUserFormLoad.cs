...
{
    public partial class levelUpBoxUserFormLoad : Form
    {
        public levelUpBoxUserFormLoad()
        {
            InitializeComponent();
        }
        ...
        private void frmLoadLevelupLoad(object sender, EventArgs e)
        {
            MainGameScreenLoad MainGameScreenLoad = new MainGameScreenLoad();
            labelStr.Text = MainGameScreenLoad.getlabelSTR.ToString();
            labelDex.Text = MainGameScreenLoad.getlabelDEX.ToString();
            labelInt.Text = MainGameScreenLoad.getlabelINT.ToString();
        ...
        {
            if (btnIncreaseSTR_Clicked == true)
            { //If else for pointsCalculation for strength.
        ...
        {
            MainGameScreenLoad.getlabelSTR = Convert.ToInt32(labelStr.Text);
            MainGameScreenLoad.getlabelINT = Convert.ToInt32(labelInt.Text);
            MainGameScreenLoad.getlabelDEX = Convert.ToInt32(labelDex.Text);
