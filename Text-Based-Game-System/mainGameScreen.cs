...
namespace Text_Based_Game_System
{
    public partial class mainGameScreen : Form
    {
        ...
        // filler 1
        // kulang ng probability pa sa choice b kasi dalawa possible outcome
        // letter b intelligence based
        ...
        // main story 3
        // letter b intelligence based di pa nailalagay
        ...
        public void fillerStory_2()
        {
            ...
            if (btnChoiceOneClicked == true)
            {
                labelMainstory.Text = "you helped the lady and it granted you something and it vanished. (+1 Sanity, -1 health) \n\nClick Continue";
                btnChoiceOneClicked = false;
                choice++;
            }
            else if (btnChoiceTwoClicked == true) //CHOICE B
            ...
            {
                labelMainstory.Text = "you were too drunk and laughed at the lady who was soaking wet in the rain. she stared into your soul and felt like she said something you can’t hear. (-1 Sanity, -1 Health) \n\nClick Continue...";
                btnChoiceThreeClicked = false;
                choice++;
            }
        }
